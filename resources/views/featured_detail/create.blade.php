...
@section('header', "Featured Detail creating form")
...
@section('content')
	...
	<div class="container">
		<div class="col-md-11">
			...
			<form action="{{ route('featuredetails.store') }}" method="post" enctype="multipart/form-data">
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            $.each(data, function(key, value) {
            	$('select[name="model_no"]').append('<option value="'+value+'">'+value+'</option>');
            });
      	}, 
      	complete: function() {
