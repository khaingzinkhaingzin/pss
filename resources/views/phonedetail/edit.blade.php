...
@section('header', "Create a new phone brand")
...
@section('content')
	...
	<div class="container">
		<div class="col-md-11">
			...
			<form action="{{ route('phonedetails.update', $id) }}" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					<select name="phonebrand" id="" class="form-control">
						<option value="" yes>Choose Phone Brand</option>
