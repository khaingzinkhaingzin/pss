   ...
   <div class="box">
        <div class="box-header with-border">
              ...
              <select name="" id="service-filter">
                <option value="">service profit by year</option>
              ...
              <select name="" id="sale-filter">
                <option value="">sale profit by each year</option>
                @foreach($years as $year)
                  <option value="{{ $year }}">{{ $year }}</option>
                @endforeach
              </select>
              ...
              <select name="" id="total-filter">
                <option value="">total profit by each year</option>
                @foreach($years as $year)
                  <option value="{{ $year }}">{{ $year }}</option>
                @endforeach
              </select>
            
              <a class="btn btn-success btn-sm" href="{{ url('costs/create') }}">create new cost</a>
